  ...
  return (<div className='bg-bgColor w-full h-[100vh] flex items-center justify-center p-6'>
    <div className='w-full md:w-2/3 h-fit lg:h-full 2xl:h-5/6 py-8 lg:py-0 flex bg-primary rounded-xl overflow-hidden shadow-xl'>
      <div className='w-full lg:w-1/2 h-full p-10 2xl:px-20 flex-col justify-center'>
        ...
        <span className='text-sm mt-2 text bg-ascent-2'></span>
      ...
      <div className='hidden w-1/2 h-full lg:flex flex-col items-center justify-center bg-blue'>
        <div className='relative w-full flex items-center justify-center'>
          <img 
            ...
            <div className='absolute flex items-center gap-1 bg-white left-10 top-6 py-2 px-4 rounded-full'>
              <ImConnection/>
              <span className='text-xs font-medium'>Connect</span>
            </div>
            <div className='absolute flex items-center gap-1 bg-white left-12 bottom-5 py-2 px-4 rounded-full'>
